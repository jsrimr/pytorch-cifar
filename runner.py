...
def net_transform_wider(net, wider):
    ...
    for param_tensor in net.state_dict():
        ...
        p_tensor = param_tensor
        if (net.state_dict()[param_tensor].size() == wider.state_dict()[p_tensor].size()):
            weight1 = net.state_dict()[param_tensor]
            wider.state_dict()[p_tensor].copy_(weight1)
            
        else :
            #print(param_tensor, "\t", wider.state_dict()[param_tensor].size())
            if("conv1" in param_tensor):
                if(first == 0):
                    diff = wider.state_dict()[p_tensor].shape[0] - net.state_dict()[param_tensor].shape[0]
                ...
                wider.state_dict()[p_tensor].copy_(changed)
                ...
                if(third == 0):
                    ...
                    wider.state_dict()[p_tensor].copy_(toadd)
                else:
                    cop = (net.state_dict()[param_tensor]).clone().detach()
                ...
                wider.state_dict()[p_tensor].copy_(toadd3)
